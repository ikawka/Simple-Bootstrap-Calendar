...
*/
(function(c){function s(c,l){this.e=isNaN(c)||null==c?g.getMonth():c;this.c=isNaN(l)||null==l?g.getFullYear():l;this.l=""}function p(){var d=new s(g.getMonth(),g.getFullYear());d.r();d=c(d.l);d.find("a.btn-next").click(function(){var d=g.getMonth(),a=g.getFullYear(),d=d+1;12==d&&(d=0,g.setFullYear(a+1));g.setMonth(d);c('[data-id="'+k+'"]').find(".dropdown-menu").empty().append(p())});d.find("a.btn-prev").click(function(){var d=g.getMonth(),a=g.getFullYear();--d;0>d&&(d=11,--a,g.setFullYear(a));g.setMonth(d);c('[data-id="'+k+'"]').find(".dropdown-menu").empty().append(p())});d.find("select.simple-calendar-month").a(function(){var d=c(this).b(),a=c('[data-id="'+k+'"]').find(".simple-calendar-year").b();g.setFullYear(a);g.setMonth(d);c('[data-id="'+k+'"]').find(".dropdown-menu").empty().append(p())});d.find("select.simple-calendar-year").a(function(){c('[data-id="'+k+'"]').find(".simple-calendar-month").a()});d.find("button.btn-calendar-ok").click(function(){c('[data-id="'+k+'"]').find(".simple-calendar-time").a()});return d}var u="Su Mo Tu We Th Fr Sa".split(" "),v="January February March April May June July August September October November December".split(" "),t="Jan Feb Mar Apr May Jun Jul Aug Sept Oct Nov Dec".split(" "),w=[31,28,31,30,31,30,31,31,30,31,30,31],g=new Date,n=new Date,q=null,m="",r="12:00 AM",d,k="";s.prototype.r=function(){var c=(new Date(this.c,this.e,1)).getDay(),l=w[this.e];1==this.e&&(0==this.c%4&&0!=this.c%100||0==this.c%400)&&(l=29);var a;a=this.e;if(!1!==d.j){for(var e='<select class="simple-calendar-month form-control">',f=0;f<t.length;f++)e+='<option value="'+f+'" '+(f==a?"selected":"")+">"+t[f]+"</option>";a='<div style="width: 60%; text-align: right">'+(e+"</select>")+"</div>"}else a='<div style="width: 60%; text-align: center; line-height: 22px;">'+v[a]+"</div>";e=this.c;if(!1!==d.o){var f='<select class="simple-calendar-year form-control">',b=g.getFullYear(),h=[];0!=d.m?h=d.m.split(":"):(h[0]=b-10,h[1]=b+10);for(b=h[0];b<=h[1];b++)f+='<option value="'+b+'" '+(b==e?"selected":"")+">"+b+"</option>";e='<div style="width: 40%; text-align: left" class="pull-right">'+(f+"</select>")+"</div>"}else e='<div style="width: 40%; text-align: center; line-height: 22px" class="pull-right">'+e+"</div>";a='<table class="table table-condense table-striped table-bordered"><tr><th><a class="simple-calendar-move btn-prev glyphicon glyphicon-chevron-left" href="javascript:;"></a></th><th colspan="5" style="text-align:center; padding: '+(!1!==d.j?"2":"4")+'px;">'+e+" "+a+'</th><th><a class="simple-calendar-move btn-next glyphicon glyphicon-chevron-right" href="javascript:;"></a></th></tr><tr class="calendar-header">';for(e=0;6>=e;e++)a+='<td class="calendar-header-day">',a+=u[e],a+="</td>";a+="</tr><tr>";f=1;for(e=0;9>e;e++){h=this.e+1;for(b=0;6>=b;b++)if(f<=l&&(0<e||b>=c)){var k=this.c+"-"+(10>h?"0"+h:h)+"-"+(10>f?"0"+f:f);a+='<td><a href="javascript:;" class="day-item'+(this.e==n.getMonth()&&this.c==n.getFullYear()&&f==n.getDate()?" today":"")+(k==m?" selected":"")+'" data-date="'+k+'">';a+=f;a+="</a></td>";f++}else a+="<td></td>";if(f>l)break;else a+="</tr><tr>"}a+="</tr>";if(1==d.f){c="";l="00";f="AM";h="";for(e=0;24>e;)f=12>e?"AM":"PM",h=0==e?12:10>e?"0"+e:e,12<h&&(h=10>h-12?"0"+(h-12):h-12),f=h+":"+l+" "+f,c+='<option value="'+(10>e?"0"+e:e)+":"+l+'" '+(r==f?"selected":"")+">"+f+"</option>","30"==l?(l="00",e++):l="30";a+='<tr><td style="line-height: 22px; font-weight: bold; padding: 2px" align="center" colspan="2">Time: </td><td style="padding: 2px" colspan="3"><select class="simple-calendar-time form-control">'+c+'</select></td><td style="line-height: 22px; font-weight: bold; padding: 2px" align="center" colspan="2"><button type="button" class="btn btn-default btn-xs btn-calendar-ok">Select</button></td></tr>'}this.l=a+"</table>"};c.B.K=function(n){d=c.extend({},{n:"btn-default",q:"Select Date",g:"YYYY-MM-dd",G:0,m:!1,j:!1,o:!1,f:!1},n);g.setHours(0);g.setMinutes(0);g.setSeconds(0);return this.w(function(l,a){c(a).C();c(a).data("settings",JSON.stringify(d));var e=k=c(a).i("id"),f=c(this).b();g=isNaN(Date.parse(f))?new Date:new Date(Date.parse(f));f=g.toISOString();m=f.split("T")[0];q=c('<div class="dropdown simple-calendar" data-id="'+e+'"><button class="btn '+d.n+' dropdown-toggle" type="button" data-toggle="dropdown"><div class="selected-text">'+d.q+'</div> <span class="caret"></span></button><div class="dropdown-menu" role="menu" style="padding: 0" id="meals-calendar-container"></div></div>').I({"shown.bs.dropdown":function(){this.d=!0},mousedown:function(b){b=c(b.target);b.h("day-item")&&(c(this).find(".table a").J("selected"),b.t("selected"))},click:function(b){b=c(b.target);this.d=!0;if(b.h("simple-calendar-move")||b.is("select")||b.is("option"))this.d=!1;else if(b.h("day-item")){1==d.f&&(this.d=!1);b=m=b.i("data-date");if(1==d.f){var e=r=c('[data-id="'+k+'"]').find(".simple-calendar-time option:selected").text();b+=" "+e}c.format&&(b=c.format.k((new Date(Date.parse(b))).toISOString(),d.g));c(a).b(b).a()}},"hide.bs.dropdown":function(){var b=this;setTimeout(function(){b.d=!0},1E3);return this.d},change:function(b){if(c(b.target).h("simple-calendar-time")){1==d.f&&(this.d=!1);b=m;if(1==d.f){var e=r=c('[data-id="'+k+'"]').find(".simple-calendar-time option:selected").text();b+=" "+e}c.format&&(b=c.format.k((new Date(Date.parse(b))).toISOString(),d.g));c(a).b(b).a()}},"shown.bs.dropdown.position-calculator":function(b,a){var d=c('[data-id="'+k+'"]').find(".dropdown-menu",b.target),e=a.relatedTarget;d.p({top:0,left:0});e=(new c.s({item:d,target:e,D:"top left",F:{y:3,x:0,H:!0},L:"bottom left",A:"both"})).v();d.p({top:e.moveBy.y+"px",left:e.moveBy.x+"px"})}});q.find("button").click(function(){k=c(a).i("id");d=JSON.parse(c(a).data("settings"));c(a).a()});c(a).u(q);c(a).a(function(){var b=c(this).b().replace(/\-/g,"/");if(isNaN(Date.parse(b))){g=new Date;var a=g.toISOString();m=a.split("T")[0]}else b=b.split("/"),g=new Date,g.setMonth(b[0]-1),g.setDate(b[1]),g.setFullYear(b[2]),a=g.toISOString(),m=a.split("T")[0],c.format&&(b=c.format.k(a,d.g)),c('[data-id="'+k+'"]').find(".selected-text").text(b);c('[data-id="'+k+'"]').find(".dropdown-menu").empty().append(p())})})}})(jQuery);
